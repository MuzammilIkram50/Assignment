...
// Addition
const additionResult: number = 8 + 2;
console.log(`Addition Result: ${additionResult}`);

// Subtraction
const subtractionResult: number = 12 - 8;
console.log(`Subtraction Result: ${subtractionResult}`);

// Multiplication
const multiplicationResult: number = 6 * 2;
console.log(`Multiplication Result: ${multiplicationResult}`);

// Division
const divisionResult: number = 16 / 4;
...
const result = add(7, 3); // Call the 'add' function with arguments (7,3) and store the result in 'result'.
console.log(result); // Print the result to the console.

// exercise 11

const names: string[] = ['Faisal', 'Zahid', 'Talha'];
...
const array: string[] = ['Faisal', 'Zahid', 'Talha'];
...
const unableToAttend: string = guestListnew[1]; // Assuming Naveed Sarwar can't make it.

console.log(`${unableToAttend} is unable to attend the dinner.`);

guestListnew[1] = 'Usman'; // Replace Naveed Sarwar with Usman.
